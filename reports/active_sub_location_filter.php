...
<span class="main_dashboard">
    ...
    <?php include('../include/connection.inc.php');
     ...
     if(isset($_POST['active_sub_location_filter'])){
    ...
    <div class="container">
     <h3 >  List of Customers by location between:</h3>
</div>
...
$query = "SELECT * FROM list_of_subscribed_customers_active WHERE county ='$county_filter' AND
