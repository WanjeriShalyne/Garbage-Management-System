<?php 
// start session and include conection
include '../include/session.php';
include '../include/connection.inc.php';


// create_payment is the name of button from admin.create.payment.php
    // if(isset($_POST['create_payment'])){
// $_POST['name of input from admin.create.payment.php']
...
//querying the sql and calling for db connection else exit execution of query and display a connection error
    ...
    while($get =mysqli_fetch_assoc($qry)){
       ...
       header("location: admin.create.payment.php");
       ?>
